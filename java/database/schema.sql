...
CREATE TABLE genre_mood (
	genre_id bigint,
	mood_id bigint,
	
	CONSTRAINT pk_genre_mood primary key (genre_id, mood_id),
	CONSTRAINT fk_genre_mood_genre_id FOREIGN KEY (genre_id) REFERENCES genre(genre_id),
	CONSTRAINT fk_genre_mood_mood_id FOREIGN KEY (mood_id) REFERENCES mood(mood_id)
);
